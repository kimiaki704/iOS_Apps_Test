        ...
        for data in metadataObjects {
            ...
            if let unwraped = transformed {
              ...
              func jsonToDictionary(input: String) throws -> [String : Any] {
                ...
                guard let jsonData = unwraped.stringValue.data(using: String.Encoding.utf8) else { return [String : Any]() }
              ...
              do {
                let jsonDic = try jsonToDictionary(input: unwraped.stringValue)
                print(jsonDic["apiKey"]!)
              } catch {
                print("error")
              }
