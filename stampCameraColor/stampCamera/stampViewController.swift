...
UICollectionViewDelegate {
    ...
    let stampArray = [UIImage(named: "p"), UIImage(named: "fusaiyou"), UIImage(named: "goukaku"), UIImage(named: "hi"), UIImage(named: "hugoukaku"), UIImage(named: "ka"), UIImage(named: "kakunin"), UIImage(named: "saiyou"), UIImage(named: "sikyu"), UIImage(named: "sumi")]
